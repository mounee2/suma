...
public class OrderDAO {
	...
	public int insert(Order order) throws BuyitException {
		...
		try {
			...
			System.out.println(order.getCustomer().getGender());
			System.out.println("before insert");
			System.out.println(order.getOrderedProductsList());
	...
	public  boolean updateOrderLine(int orderId, int productId, int quantity) throws BuyitException {
